<header id="menu-bar">
    ...
    <ul id="bottom-section">
        ...
        <li onclick="menuclick('shopping-cart.php')"><img src="IMAGES/ICONS/cart-white.svg" alt="Shopping Cart Icon"></li>
        <li><img id="notification-icon" src="IMAGES/ICONS/bell-white.svg" alt="Notification Icon"></li>
        <li onclick="menuclick('account.php')"><img id="account-icon" src="IMAGES/ICONS/user-white.svg" alt="Account Icon"></li>
    </ul>
</header>